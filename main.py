...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash("You have already signed up with this e-mail, log in instead.")
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, log_in=current_user.is_authenticated, form=form)
